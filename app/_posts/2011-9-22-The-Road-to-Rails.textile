...
With these three points Rails does what it does. Seeing Rails in action has allowed me to reach only one logical conclusion i.e it was created by the Vulcans. No other race is smart enough. If you are looking forward to learn some rails, <a href="http://guides.rubyonrails.org/getting_started.html">this</a> is a good place to start.
